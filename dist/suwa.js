...
function addCss () {
	...
	style.textContent = "\n[svelte-2783279863].box, [svelte-2783279863] .box {\n  position: relative;\n  overflow: hidden;\n}\n\n[svelte-2783279863].page-container, [svelte-2783279863] .page-container {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: calc(100% + 30px);\n  transition: .4s cubic-bezier(0.645, 0.045, 0.355, 1);\n}\n\n[svelte-2783279863].pages, [svelte-2783279863] .pages {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: calc(100% - 30px);\n  display: flex;\n}\n\n[svelte-2783279863].pages .page-wrapper, [svelte-2783279863] .pages .page-wrapper {\n  min-width: 100vw;\n  max-width: 100vw;\n  background-color: #fff;\n  box-sizing: border-box;\n  padding: 1em;\n  position: relative;\n  z-index: 1;\n}\n\n[svelte-2783279863].pages .page-wrapper > *, [svelte-2783279863] .pages .page-wrapper > * {\n  position: absolute;\n  z-index: 1;\n}\n\n[svelte-2783279863].progress, [svelte-2783279863] .progress {\n  position: absolute;\n  left: 0;\n  width: 100%;\n  height: 2px;\n  box-sizing: border-box;\n}\n\n[svelte-2783279863].progress.bar, [svelte-2783279863] .progress.bar {\n  transition: .4s cubic-bezier(0.55, 0.055, 0.675, 0.19);\n}\n\n[svelte-2783279863].pager, [svelte-2783279863] .pager {\n  position: absolute;\n  right: 50%;\n  transform: translateX(50%);\n  display: flex;\n  z-index: 1;\n}\n\n[svelte-2783279863].pager:first-of-type, [svelte-2783279863] .pager:first-of-type {\n  z-index: 2;\n}\n\n[svelte-2783279863].pager-links, [svelte-2783279863] .pager-links {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  transition: .2s cubic-bezier(0.645, 0.045, 0.355, 1);\n  box-sizing: border-box;\n  overflow: hidden;\n}\n\n[svelte-2783279863].pager-link, [svelte-2783279863] .pager-link {\n  display: flex;\n  align-items: center;\n  position: relative;\n  width: .75em;\n  height: .75em;\n  min-width: .75em;\n  min-height: .75em;\n  margin: .5em;\n  cursor: pointer;\n  transition: .2s cubic-bezier(0.645, 0.045, 0.355, 1);\n}\n\n[svelte-2783279863].pager-link:not(.prev):not(.next), [svelte-2783279863] .pager-link:not(.prev):not(.next) {\n  background: #222;\n  border-radius: 50%;\n}\n\n[svelte-2783279863].pager-link svg, [svelte-2783279863] .pager-link svg {\n  display: block;\n  fill: #222;\n  width: .5em;\n  transition: .2s cubic-bezier(0.645, 0.045, 0.355, 1);\n}\n";
...
function renderIfBlock_0 ( root, component ) {
	...
	setAttribute( div, 'svelte-2783279863', '' );
	component.refs.suwa = div;
	div.className = "suwa box";
	div.style.cssText = "\n    width: " + ( root.style.width ) + ";\n    height: " + ( root.style.height ) + ";\n  ";
	
	var div1 = createElement( 'div' );
	setAttribute( div1, 'svelte-2783279863', '' );
	...
	setAttribute( div2, 'svelte-2783279863', '' );
...
function renderIfBlock2_0 ( root, component ) {
	...
	setAttribute( a, 'svelte-2783279863', '' );
	...
	setAttribute( svg, 'svelte-2783279863', '' );
	...
	setAttribute( path, 'svelte-2783279863', '' );
	...
	setAttribute( a1, 'svelte-2783279863', '' );
	...
	setAttribute( a2, 'svelte-2783279863', '' );
	...
	setAttribute( a3, 'svelte-2783279863', '' );
	...
	setAttribute( svg1, 'svelte-2783279863', '' );
	...
	setAttribute( path1, 'svelte-2783279863', '' );
	...
	setAttribute( div3, 'svelte-2783279863', '' );
